        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "model_type",
                    models.CharField(
                        blank=True, max_length=50, null=True, verbose_name="기종"
                    ),
                ),
            ...
            options={
                "constraints": [
                    models.UniqueConstraint(
                        condition=models.Q(
                            ("end_min__isnull", True), ("start_min__isnull", True)
                        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="gibun_teams", to="manhour.worker"
                    ),
                ),
                (
                    "session",
            ...
            options={
                "indexes": [
                    models.Index(
                        ...
                        name="manhour_gib_session_3525d4_idx",
                    )
                ],
                "unique_together": {("session", "gibun")},
            },
