...
urlpatterns = [
    ...
    path("workplace/change/", views.ChangeWorkplaceView.as_view(), name="change_workplace"),
    ...
    path("session/<int:session_id>/paste/", views.PasteInputView.as_view(), name="paste_data"),
    path("session/<int:session_id>/paste-items/", views.PasteItemsView.as_view(), name="paste_items"),
    path("session/<int:session_id>/upload/", views.LegacyUploadRedirectView.as_view(), name="legacy_upload_redirect"),
    # 개별 아이템 및 기능
    path("session/<int:session_id>/reorder-items/", views.ReorderItemsView.as_view(), name="reorder_items"),
    path("reorder-gibun/<int:session_id>/<str:gibun_name>/<str:direction>/", views.ReorderGibunView.as_view(), name="reorder_gibun"),
    ...
    # 리셋
    path("session/<int:session_id>/worker/<int:worker_id>/manual_reset/", views.ResetWorkerManualInputView.as_view(), name="reset_worker_manual_input"), 
    ...
    path("history/<int:session_id>/delete/", views.delete_history_session, name="delete_history_session"),
    ...
    path("master-data/delete/<int:pk>/", views.TaskMasterDeleteView.as_view(),
        name="delete_taskmaster",),
    path("taskmaster/delete/<int:session_id>/", views.DeleteTaskMasterView.as_view(),
