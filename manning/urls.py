...
urlpatterns = [
    ...
    path( "master-data/delete/<int:pk>/", views.TaskMasterDeleteView.as_view(), name="delete_taskmaster" ),
    path( "master-data/delete-all/", views.TaskMasterDeleteAllView.as_view(), name="delete_all_taskmasters" ),

    # youtube video 관리
    path("videos/", views.YoutubeVideoListView.as_view(), name="video_list"),  
]
